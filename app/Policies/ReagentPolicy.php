...
class ReagentPolicy
{
    ...
    {
        return $user->can('view_any_reagent');
    }
    ...
    {
        return $user->can('create_reagent');
    }
    ...
    {
        return $user->can('update_reagent');
    }
    ...
    {
        return $user->can('delete_reagent');
    }
    ...
    {
        return $user->can('delete_any_reagent');
    }
     ...
     */
    public function replicate(User $user, Reagent $reagent): bool
    {
